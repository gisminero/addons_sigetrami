...
class CK_GCM_PARAMS(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, CK_GCM_PARAMS, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, CK_GCM_PARAMS, name)
    __repr__ = _swig_repr
    __swig_setmethods__["pIv"] = _LowLevel.CK_GCM_PARAMS_pIv_set
    __swig_getmethods__["pIv"] = _LowLevel.CK_GCM_PARAMS_pIv_get
    if _newclass:
        pIv = _swig_property(_LowLevel.CK_GCM_PARAMS_pIv_get, _LowLevel.CK_GCM_PARAMS_pIv_set)
    __swig_setmethods__["ulIvLen"] = _LowLevel.CK_GCM_PARAMS_ulIvLen_set
    __swig_getmethods__["ulIvLen"] = _LowLevel.CK_GCM_PARAMS_ulIvLen_get
    if _newclass:
        ulIvLen = _swig_property(_LowLevel.CK_GCM_PARAMS_ulIvLen_get, _LowLevel.CK_GCM_PARAMS_ulIvLen_set)
    __swig_setmethods__["pAAD"] = _LowLevel.CK_GCM_PARAMS_pAAD_set
    __swig_getmethods__["pAAD"] = _LowLevel.CK_GCM_PARAMS_pAAD_get
    if _newclass:
        pAAD = _swig_property(_LowLevel.CK_GCM_PARAMS_pAAD_get, _LowLevel.CK_GCM_PARAMS_pAAD_set)
    __swig_setmethods__["ulAADLen"] = _LowLevel.CK_GCM_PARAMS_ulAADLen_set
    __swig_getmethods__["ulAADLen"] = _LowLevel.CK_GCM_PARAMS_ulAADLen_get
    if _newclass:
        ulAADLen = _swig_property(_LowLevel.CK_GCM_PARAMS_ulAADLen_get, _LowLevel.CK_GCM_PARAMS_ulAADLen_set)
    __swig_setmethods__["ulTagBits"] = _LowLevel.CK_GCM_PARAMS_ulTagBits_set
    __swig_getmethods__["ulTagBits"] = _LowLevel.CK_GCM_PARAMS_ulTagBits_get
    if _newclass:
        ulTagBits = _swig_property(_LowLevel.CK_GCM_PARAMS_ulTagBits_get, _LowLevel.CK_GCM_PARAMS_ulTagBits_set)

    def __init__(self):
        this = _LowLevel.new_CK_GCM_PARAMS()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
CK_GCM_PARAMS_swigregister = _LowLevel.CK_GCM_PARAMS_swigregister
CK_GCM_PARAMS_swigregister(CK_GCM_PARAMS)
